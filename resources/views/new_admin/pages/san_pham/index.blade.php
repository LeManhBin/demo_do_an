                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                <label>Tên Sản Phẩm</label>
                                                <input type="text" class="form-control" id="ten_san_pham" placeholder="Nhập vào tên sản phẩm">
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                <label>Slug Sản Phẩm</label>
                                                <input type="text" class="form-control" id="slug_san_pham" placeholder="Nhập vào slug sản phẩm">
                                            </fieldset>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <fieldset class="form-group">
                                                <label>Giá Bán</label>
                                                <input type="number" class="form-control" id="gia_ban" placeholder="Nhập vào giá bán">
                                            </fieldset>
                                        </div>
                                        <div class="col-md-4">
                                            <fieldset class="form-group">
                                                <label>Giá Khuyến Mãi</label>
                                                <input type="number" class="form-control" id="gia_khuyen_mai" placeholder="Nhập vào giá khuyến mãi">
                                            </fieldset>
                                        </div>
                                        <div class="col-md-4">
                                            <fieldset class="form-group">
