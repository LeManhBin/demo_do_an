    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item"><a class="navbar-brand" href="/new_assets_admin/html/ltr/vertical-menu-template-semi-dark/index.html"><img class="brand-logo" alt="stack admin logo" src="/new_assets_admin/app-assets/images/logo/stack-logo-light.png">
