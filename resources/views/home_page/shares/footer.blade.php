        ...
        <div class="container">
            <div class="footer-middle-content pt-20 pb-30">
                    <ul class="social-footer">
                        ...
                        <li><a href="#"><img src="/assets_homepage/img/icon/social-img1.png" alt="google play"></a></li>
                        <li><a href="#"><img src="/assets_homepage/img/icon/social-img2.png" alt="app store"></a></li>
                    </ul>
            </div>
        </div>
        <!-- Container End -->
